...
<div class="text-h5">
{{ Math.round((kpi.expense / kpi.revenue) * 100) }} %
</div>
</q-card>
...
this.vehicleSeries = JSON.parse(JSON.stringify([
{
name:"Vehicle Profit",
...
this.vehicleChartOptions = JSON.parse(JSON.stringify({
chart:{
id:"vehicle"
},
plotOptions:{
...
xaxis:{
categories: vehicles.map(
v => v.vehicle_number + " (" + v.vehicle_type + ")"
)
}
}))
